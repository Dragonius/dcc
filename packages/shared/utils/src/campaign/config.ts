...
export const Config: Config = {
	...
	packages: {
		...
		"Pinpoint Strike": { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 300_000, aircrafts: 2 },
		Escort: { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 200_000, aircrafts: 2 },
		CAS: { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 200_000, aircrafts: 2 },
		DEAD: { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 300_000, aircrafts: 2 },
		SEAD: { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 300_000, aircrafts: 2 },
		CSAR: { maxActive: { blue: 4, red: 4, neutrals: 1 }, maxDistance: 80_000, aircrafts: 1 },
		CAP: { maxActive: { blue: 4, red: 4, neutrals: 0 }, maxDistance: 200_000, aircrafts: 2 },
		"Air Assault": { maxActive: { blue: 4, red: 4, neutrals: 4 }, maxDistance: 40_000, aircrafts: 2 },
	},
	structureRange: {
		power: 50_000,
		ammo: 50_000,
		...
		generateRangeMultiplier: { blue: 1, red: 0.8, neutrals: 0 },
	},
	deploymentScore: {
		base: 12,
		penalty: {
